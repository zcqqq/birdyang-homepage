...
import { StateStore, StateModel, VisibilityCondition, VisibilityContext, ActionHandler, ResolvedAction, ActionBinding, ActionConfirm, ValidationFunction, ValidationResult, ValidationConfig, Catalog, UIElement, SchemaDefinition, Spec, FlatElement } from '@json-render/core';
export { Spec, StateModel, StateStore, createStateStore } from '@json-render/core';
export { InkSchema, InkSpec, schema } from './schema.js';
import { Components, Actions, SetState } from './server.js';
export { ActionFn, ComponentContext, ComponentFn } from './server.js';
...
declare function FocusProvider({ children }: {
 ...
 */
declare function useFocusDisable(disabled: boolean): void;
 ...
 */
declare function JSONUIProvider({ store, initialState, handlers, navigate, validationFunctions, onStateChange, children, }: JSONUIProviderProps): react_jsx_runtime.JSX.Element;
/**
...
}>(_catalog: Catalog<TDef, TCatalog>, components: ComponentMap<TCatalog["components"]>): ComponentType<CreateRendererProps>;
